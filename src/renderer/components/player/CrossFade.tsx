...
export default class CrossFade extends React.Component {
  ...
  render() {
    if (this.props.scene.crossFade) {
      return <this.FadeLayer>{this.props.children}</this.FadeLayer>;
    } else {
  ...
  FadeLayer = (data: { children: React.ReactNode }) => {
    ...
    switch (this.props.scene.fadeTF) {
      ...
      case TF.sin:
        const sinRate =
          (Math.abs(this.props.scene.fadeSinRate - 100) + 2) * 1000;
        fadeDuration =
          Math.floor(
        ...
        },
        {
          ...
          config: {
            ...
            easing: getEaseFunction(
              this.props.scene.fadeEase,
              this.props.scene.fadeExp,
              this.props.scene.fadeAmp,
              this.props.scene.fadePer,
              this.props.scene.fadeOv,
            ),
          },
        },
      );
