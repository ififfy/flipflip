    ...
    return (
      <div className={classes.root}>
        ...
        <main
          className={clsx(
            classes.content,
            this.state.hideCursor && classes.hideCursor,
          )}
                          ...
                          {scene && (
                            <Player
                              ...
                              captionScale={
                                1 /
                                Math.sqrt(
                                  row.length * this.props.scene.grid.length,
                                )
                              }
                              allLoaded={allLoaded}
                              ...
                              onLoaded={this.setCellLoaded.bind(
                                this,
                                rowIndex,
                                colIndex,
                              )}
                              ...
                              setProgress={
                                showProgress ? this.props.setProgress : this.nop
                              }
                              setSceneCopy={this.setSceneCopy.bind(
                                this,
                                rowIndex,
                                colIndex,
                              )}
                              setVideo={
                                this.props.setVideo
                                  ? this.props.setVideo.bind(
                                      this,
                                      rowIndex * row.length + colIndex,
                                    )
                                  : undefined
                              }
                              systemMessage={this.props.systemMessage.bind(
                                this,
                              )}
                            />
                          )}
