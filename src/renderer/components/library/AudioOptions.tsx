    ...
    return (
      ...
      >
          ...
          <Grid container spacing={2} alignItems="center">
            ...
            <Grid item xs={12}>
              <AudioControl
                ...
                scenePaths={[]}
                startPlaying={false}
                onAudioSliderChange={this.onSourceSliderChange.bind(
                  this,
                  "volume",
                )}
              />
            ...
            <Grid item xs={12}>
              <Grid container spacing={2} alignItems="center">
                <Grid item>
                  <Collapse
                    in={
                      !this.state.audio.tick && !this.state.audio.nextSceneAtEnd
                    }
                  >
                    <FormControlLabel
                      control={
                  ...
                  <Collapse
                    in={!this.state.audio.tick && !this.state.audio.stopAtEnd}
                  >
                    <FormControlLabel
                      control={
                        <Switch
                  ...
                  <Collapse
                    in={
                      !this.state.audio.stopAtEnd &&
                      !this.state.audio.nextSceneAtEnd
                    }
                  >
                    <FormControlLabel
                      control={
                  ...
                  <Grid container>
                          ...
                          endAdornment: (
                            <InputAdornment position="end">
                              <Tooltip disableInteractive title="Detect BPM">
                                <IconButton
                                  className={clsx(
                                    this.state.successBPM && classes.success,
                                    this.state.errorBPM && classes.failure,
                                  )}
                                  onClick={this.onDetectBPM.bind(this)}
                                  size="large"
                                >
                                  {this.state.successBPM ? (
                                    <CheckIcon />
                                  ) : this.state.errorBPM ? (
                                    <ErrorOutlineIcon />
                                  ) : (
                              ...
                              >
                                <IconButton
                                  className={clsx(
                                    this.state.successTag && classes.success,
                                    this.state.errorTag && classes.failure,
                                  )}
                                  onClick={this.onReadBPMTag.bind(this)}
                                  size="large"
                                >
                                  {this.state.successTag ? (
                                    <CheckIcon />
                                  ) : this.state.errorTag ? (
                                    <ErrorOutlineIcon />
                                  ) : (
                    ...
                    <Grid item xs={12}>
                      ...
                      <Slider
                        ...
                        onChangeCommitted={this.onSourceSliderChange.bind(
                          this,
                          "speed",
                        )}
            ...
            <Grid
              item
              xs={12}
              className={clsx(!this.state.audio.tick && classes.noPadding)}
            >
              <Collapse
                in={this.state.audio.tick}
              ...
              >
                <Grid container spacing={2} alignItems="center">
                  ...
                  <Grid item xs={12} sm={8}>
                    <Collapse
                      in={this.state.audio.tickMode == TF.sin}
                      className={classes.fullWidth}
                    >
                      <Typography
                        variant="caption"
                      ...
                      <Grid container alignItems="center">
                        ...
                        <Grid item xs={3} className={classes.percentInput}>
                          <TextField
                            ...
                            onChange={this.onSourceIntInput.bind(
                              this,
                              "tickSinRate",
                            )}
                            onBlur={this.blurSourceIntKey.bind(
                              this,
                              "tickSinRate",
                            )}
                            inputProps={{
                    ...
                    <Collapse
                      in={this.state.audio.tickMode == TF.bpm}
                      className={classes.fullWidth}
                    >
                      <Typography
                        variant="caption"
                      ...
                      >
                        BPM Multiplier{" "}
                        {this.state.audio.tickBPMMulti > 0
                          ? this.state.audio.tickBPMMulti
                          : "1 / " + -1 * (this.state.audio.tickBPMMulti - 2)}
                        x
                      </Typography>
                      <Slider
                        min={-8}
                    ...
                    <Collapse
                      in={this.state.audio.tickMode == TF.constant}
                      className={classes.fullWidth}
                    >
                      <TextField
                        variant="outlined"
            ...
            >
              <Collapse
                in={
                  this.state.audio.tick &&
                  (this.state.audio.tickMode == TF.random ||
                    this.state.audio.tickMode == TF.sin)
                }
                className={classes.fullWidth}
              >
                <Grid container alignItems="center">
        ...
        <DialogActions className={classes.actions}>
          ...
          <Button
            onClick={this.props.onFinishEdit.bind(this, this.state.audio)}
            color="primary"
          >
            Save
          </Button>
