...
import { isAudio } from "../../../main/scraper/Scrapers";
...
class AudioLibrary extends React.Component {
  ...
  render() {
    ...
    const playlist = this.state.filters
      ...
      <div className={classes.root}>
        <AppBar
          ...
          className={clsx(
            ...
            this.props.tutorial == ALT.toolbar &&
          ...
          <Toolbar className={classes.headerBar}>
            ...
            <div className={classes.headerRight}>
              <div
                className={clsx(
                  classes.searchBar,
                  this.props.tutorial == ALT.toolbar && classes.highlight,
                )}
              >
        ...
        <Drawer
          className={clsx(
            classes.drawer,
            (this.props.tutorial == ALT.sidebar1 ||
              this.props.tutorial == ALT.sidebar2 ||
              this.state.drawerOpen) &&
              classes.backdropTop,
            this.props.tutorial == ALT.sidebar2 && classes.highlight,
          )}
          variant="permanent"
          classes={{
        ...
        >
          ...
          <ListItem className={classes.drawerButton}>
            <IconButton
              className={clsx(
                this.props.tutorial == ALT.sidebar1 && classes.highlight,
              )}
          ...
          <div className={clsx(this.props.tutorial != null && classes.disable)}>
            ...
            >
              <ListItem
                button
                onClick={this.props.onManageTags.bind(this)}
                disabled={this.props.specialMode != null}
              >
                <ListItemIcon>
                  <LocalOfferIcon />
                </ListItemIcon>
            ...
            <Tooltip
              disableInteractive
              title={this.state.drawerOpen ? "" : "Add to Playlist"}
            >
              <ListItem
                button
                onClick={this.onAddToPlaylist.bind(this)}
                disabled={this.props.specialMode != null}
              >
                <ListItemIcon>
                  <PlaylistAddIcon />
            ...
            >
              <ListItem
                button
                onClick={this.onBatchTag.bind(this)}
                disabled={this.props.specialMode != null}
              >
                <ListItemIcon>
            ...
            <Tooltip
              disableInteractive
              title={this.state.drawerOpen ? "" : "Batch Edit"}
            >
              <ListItem
                button
                onClick={this.onBatchEdit.bind(this)}
                disabled={this.props.specialMode != null}
              >
                <ListItemIcon>
                  <EditIcon />
          ...
          <div className={clsx(this.props.tutorial != null && classes.disable)}>
            <Tooltip disableInteractive title={"BPM Detection"}>
              <ListItem
                ...
                onClick={this.props.onBatchDetectBPM.bind(this)}
              >
                <ListItemIcon>
          ...
          {this.props.progressMode != null && (
            <React.Fragment>
              ...
              <div>
                <Tooltip
                  disableInteractive
                  title={this.state.drawerOpen ? "" : "Cancel BPM Detection"}
                >
                  <ListItem
                    button
                ...
                <div className={classes.tabPanel}>
                  ...
                  <Box className={classes.fill}>
                    <AudioSourceList
                      ...
                      onUpdatePlaylists={this.props.onUpdatePlaylists.bind(
                        this,
                      )}
        ...
        {!this.props.specialMode && this.props.openTab == 3 && (
          <React.Fragment>
              ...
              {this.state.filters.length > 0 && playlist && (
                <React.Fragment>
                  ...
                  <DialogActions>
                    ...
                    <Button
                      onClick={this.onFinishRemovePlaylist.bind(this)}
                      color="primary"
                    >
                      Confirm
                    </Button>
            ...
            <Tooltip
              disableInteractive
              title={this.state.filters.length > 0 ? "" : "Local Audio"}
              placement="left"
            >
              <Fab
                className={clsx(
                  ...
                  <MenuItem key={sf}>
                    ...
                    <ListItemSecondaryAction>
                      <IconButton
                        ...
                        onClick={
                          playlist
                            ? this.props.onSortPlaylist.bind(
                                this,
                                playlist,
                                sf,
                                true,
                              )
                            : this.props.onSort.bind(this, sf, true)
                        }
                        size="large"
                      >
                        <ArrowUpwardIcon />
                      ...
                      <IconButton
                        ...
                        onClick={
                          playlist
                            ...
                            : this.props.onSort.bind(this, sf, false)
                        }
                        size="large"
                      >
                        <ArrowDownwardIcon />
                  ...
                  <IconButton
                    ...
                    onClick={
                      playlist
                        ...
                        : this.props.onSort.bind(this, ASF.random, true)
                    }
                    size="large"
                  >
                    <ShuffleIcon />
          ...
          >
            ...
            <DialogActions>
              ...
              <Button
                ...
                onClick={this.onAddURL.bind(this)}
                color="primary"
              >
                Import
              </Button>
        ...
        {this.state.openMenu == MO.newPlaylist && (
          ...
          >
            ...
            <DialogActions>
              ...
              <Button onClick={this.onAddPlaylist.bind(this)} color="primary">
                Create Playlist
              </Button>
            </DialogActions>
          </Dialog>
        ...
        {this.state.openMenu == MO.playlistDuplicates && (
          ...
          >
            ...
            <DialogActions>
              <Button
                onClick={this.onSkipDuplicates.bind(this)}
                color="secondary"
              >
                Skip Duplicates
              </Button>
              <Button onClick={this.onAddDuplicates.bind(this)} color="primary">
                Add Anyway
              </Button>
            </DialogActions>
          </Dialog>
          ...
          >
            ...
            <DialogContent className={classes.noScroll}>
              <DialogContentText id="batch-tag-description">
                Choose tags to add, remove, or overwrite on the selected
                source(s)
              </DialogContentText>
              {this.state.openMenu == MO.batchTag && (
                <LibrarySearch
            ...
            <DialogActions>
              ...
              <Button
                onClick={this.batchTagOverwrite.bind(this)}
                color="primary"
              >
                Overwrite
              </Button>
  ...
  componentDidUpdate(props: any, state: any) {
    if (
      ...
      props.playlists != this.props.playlists
    ) {
      this.setState({ displaySources: this.getDisplaySources() });
    }
  ...
  onAddSource(type: string, e: MouseEvent) {
    ...
    switch (type) {
      case AF.url:
        ...
        break;
      case AF.audios:
        window.ipc.openAudios(e.shiftKey).then((result) => {
          if (result.length === 0) {
            return;
          }

          this.setState({ loadingSources: true });
          this.addAudioSources(result);
        });
        break;
    }
  }
  ...
  onAddURL() {
    ...
    if (
      sourceURLs.includes(this.state.importURL) ||
      !isAudio(this.state.importURL, false)
    ) {
  ...
  onChoosePlaylist(playlistID: number) {
    if (playlistID == -1) {
      ...
      this.props.onUpdatePlaylists((ps) => {
        ...
        if (playlist) {
          playlist.audios = playlist.audios.concat(
            this.state.selected.map(
              (s) => this.props.library.find((a) => a.url == s)?.id,
            ),
          );
        }
      });
  ...
  onAddPlaylist() {
    ...
    const playlist = new Playlist({
      id: id,
      name: name,
      audios: this.state.selected.map(
        (s) => this.props.library.find((a) => a.url == s)?.id,
      ),
    });
    this.props.onUpdatePlaylists((ps) => {
  ...
  onFinishRemovePlaylist() {
    this.props.onUpdatePlaylists((pl) => {
      const playlistName = this.state.filters
        .find((f) => f.startsWith("playlist:"))
        ?.replace("playlist:", "");
      pl.forEach((p, index) => {
  ...
  getDisplaySources() {
    ...
    if (filtering) {
      ...
      const library: Array<Audio> = playlist
        ? playlist.audios.map((aID) =>
            this.props.library.find((a) => a.id == aID),
          )
        : this.props.library;
