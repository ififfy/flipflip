...
import { getSourceType, proxy } from "../../../common/utils";
  ...
  batchClipFinish() {
    ...
    const successCallback = (video: HTMLVideoElement, sourceURL: string) => {
      ...
      source.clips.push(
        new Clip({
          id: id,
          start: this.state.clipOffset[0] / 1000,
          end: video.duration - this.state.clipOffset[1] / 1000,
        }),
      );
      createBatchClips();
    };
