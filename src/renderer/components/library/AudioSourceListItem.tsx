    ...
    return (
      <div
        ...
        className={clsx(
          ...
          this.props.lastSelected && classes.lastSelected,
        )}
      >
        <ListItem classes={{ root: classes.listItem }}>
          ...
          >
            <ListItemAvatar className={classes.listAvatar}>
              ...
              >
                <Tooltip
                  disableInteractive
                  placement={this.props.source.comment ? "right" : "bottom"}
                  classes={
                  ...
                  arrow={
                    !!this.props.source.comment ||
                    this.props.source.tags.length > 0
                  }
                  title={
                    this.props.source.comment ||
                    this.props.source.tags.length > 0 ? (
                      <div className={classes.preLine}>
                        {this.props.source.comment}
                        {this.props.source.comment &&
                          this.props.source.tags.length > 0 && <br />}
                    ...
                    {this.props.source.thumb == null && (
                      ...
                      >
                        <SourceIcon
                          ...
                          className={clsx(
                            classes.sourceIcon,
                            this.props.source.marked &&
                              classes.sourceMarkedIcon,
                          )}
                        />
                      </Fab>
                    )}
          ...
          <ListItemText classes={{ primary: classes.root }}>
            ...
            <div
              ...
              onClick={this.props.onClickArtist.bind(
                this,
            ...
            <div
              ...
              onClick={this.props.onClickAlbum.bind(
                this,
