  ...
  render() {
    ...
    return (
      <div
        ...
        className={clsx(
          this.props.index % 2 == 0 ? classes.evenChild : classes.oddChild,
        ...
        <ListItem>
          {this.props.isSelect && (
            <Checkbox
              ...
              onChange={this.props.onToggleSelect.bind(this)}
            ...
            >
              ...
              >
                <Fab
                  ...
                  className={clsx(
                    classes.avatar,
                    this.props.source.marked && classes.markedSource,
                ...
                >
                  <SourceIcon
                    ...
                    className={clsx(
                      classes.sourceIcon,
                      this.props.source.marked && classes.sourceMarkedIcon,
                    )}
                  />
                </Fab>
              </Tooltip>
          ...
          <ListItemText classes={{ primary: classes.root }}>
            {this.props.isEditing == this.props.source.id && (
              <form
                onSubmit={this.onEndEdit.bind(this)}
              ...
              <React.Fragment>
                <Typography
                  ...
                  className={clsx(
                    ...
                    this.props.tutorial == SDT.sourceTitle && classes.highlight,
                  )}
                  onClick={this.onStartEdit.bind(this, this.props.source)}
                >
                  {this.props.source.url}
                </Typography>
                {this.props.source.tags &&
                  this.props.source.tags.map((tag: Tag) => (
          ...
          {this.props.isEditing != this.props.source.id && (
            <ListItemSecondaryAction
              className={clsx(
                classes.source,
                this.props.tutorial == SDT.sourceButtons && classes.highlight,
              )}
            >
              ...
              {this.props.source.count > 0 && sourceType != ST.video && (
                <Chip
                  className={clsx(
                    classes.countChip,
                    this.props.tutorial == SDT.sourceCount && classes.highlight,
                  )}
              ...
              {!this.props.isLibrary &&
                ...
                this.props.source.clips.length > 0 &&
                sourceType == ST.video && (
                  <Chip
                    className={classes.countChip}
                    label={
                      (this.props.source.disabledClips
                        ? this.props.source.clips.filter(
                            (c) =>
                              !this.props.source.disabledClips.includes(c.id),
                          )
                        : this.props.source.clips
                      ).length +
                      "/" +
                      this.props.source.clips.length
                    }
                    onClick={this.props.onOpenClipMenu.bind(
                      this,
                      this.props.source,
                    )}
                    color="primary"
              ...
              {this.props.source.blacklist &&
                this.props.source.blacklist.length > 0 && (
                  <IconButton
