...
class TagManager extends React.Component<TagManagerProps> {
        ...
        <main className={classes.content}>
          ...
          >
            ...
            <DialogActions>
              ...
              <Button
                onClick={this.onCloseEditDialog.bind(this)}
                color="secondary"
              >
                Cancel
              </Button>
              <Button
                ...
                onClick={this.onFinishEdit.bind(this)}
                color="primary"
              >
                OK
              </Button>
  ...
  onRemoveTag() {
    this.setState({
      tags: this.state.tags.filter((t) => t.id != this.state.isEditing),
      isEditing: -1,
      tagName: "",
      tagPhrase: "",
    });
  ...
  onCloseEditDialog() {
    if (
      this.state.isEditing == this.state.tags[this.state.tags.length - 1].id &&
      this.state.tagName === ""
    ) {
      this.onRemoveTag();
    } else {
