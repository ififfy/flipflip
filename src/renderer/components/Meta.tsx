...
export default class Meta extends React.Component {
  ...
  onAddScene() {
    ...
    let scene = new Scene({
      ...
      timingFunction: this.state.config.defaultScene.timingFunction,
      timingConstant: this.state.config.defaultScene.timingConstant,
      imageTypeFilter: this.state.config.defaultScene.imageTypeFilter,
      zoomType: this.state.config.defaultScene.zoomType,
      effectLevel: this.state.config.defaultScene.effectLevel,
      horizTransType: this.state.config.defaultScene.horizTransType,
      vertTransType: this.state.config.defaultScene.vertTransType,
      crossFade: this.state.config.defaultScene.crossFade,
      backgroundType: this.state.config.defaultScene.backgroundType,
      backgroundColor: this.state.config.defaultScene.backgroundColor,
      playFullGif: this.state.config.defaultScene.playFullGif,
      textKind: this.state.config.defaultScene.textKind,
      textSource: this.state.config.defaultScene.textSource,
      overlaySceneID: this.state.config.defaultScene.overlaySceneID,
      overlaySceneOpacity: this.state.config.defaultScene.overlaySceneOpacity,
    });
    this.setState({
