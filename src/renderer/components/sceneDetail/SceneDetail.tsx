...
class SceneDetail extends React.Component<SceneDetailProps> {
    ...
    return (
      <div className={classes.root}>
        <AppBar
          ...
          className={clsx(
            classes.appBar,
            (this.props.tutorial == SDT.title ||
              this.props.tutorial == SDT.play) &&
              classes.backdropTop,
          )}
        >
          <Toolbar>
            ...
            {this.state.isEditingName == null && (
              <React.Fragment>
                ...
                <Typography
                  ...
                  className={clsx(
                    classes.title,
                    this.props.scene.name.length == 0 && classes.noTitle,
                    this.props.tutorial == SDT.title && classes.highlight,
                  )}
            ...
            <Fab
              className={clsx(
                classes.playButton,
                this.props.tutorial == SDT.play && classes.highlight,
              )}
              disabled={
                this.props.scene.sources.length == 0 &&
                (!this.props.scene.regenerate ||
        ...
        <Drawer
          className={clsx(
            ...
            (this.state.drawerOpen ||
              this.props.tutorial == SDT.options1 ||
              this.props.tutorial == SDT.effects1) &&
              classes.backdropTop,
          )}
          variant="permanent"
          classes={{
        ...
        >
            ...
            >
              <Tab
                ...
                className={clsx(
                  ...
                  this.props.tutorial == SDT.options1 && classes.highlight,
                  this.props.tutorial == SDT.effects1 && classes.disable,
                )}
              />
              <Tab
                id="vertical-tab-1"
                ...
                className={clsx(
                  ...
                  classes.effectsTab,
                  !open && classes.tabClose,
                  this.props.tutorial == SDT.options1 && classes.disable,
                  this.props.tutorial == SDT.effects1 && classes.highlight,
                )}
              />
              <Tab
                id="vertical-tab-2"
              ...
              <Tab
                ...
                label={
                  open ? `Sources (${this.props.scene.sources.length})` : ""
                }
                className={clsx(
                  classes.tab,
                  classes.sourcesTab,
              ...
              {this.props.scene.generatorWeights && (
                <Tab
                  ...
                  label={
                    open
                      ? `Generate (${this.props.scene.generatorWeights.length})`
                      : ""
                  }
                  className={clsx(
                    classes.tab,
          ...
          <div>
            {this.props.scene.generatorWeights && (
              <ListItem
                button
                onClick={this.props.onSaveAsScene.bind(this, this.props.scene)}
                className={clsx(
                  (this.props.tutorial == SDT.options1 ||
                    this.props.tutorial == SDT.effects1) &&
                    classes.disable,
            ...
            <Tooltip
              ...
              title={
                this.state.drawerOpen
                  ? ""
                  : `Clone ${this.props.scene.generatorWeights ? "Generator" : "Scene"}`
              }
            >
              <ListItem
                button
                onClick={this.props.onCloneScene.bind(this, this.props.scene)}
                className={clsx(
                  (this.props.tutorial == SDT.options1 ||
                    this.props.tutorial == SDT.effects1) &&
                    classes.disable,
              ...
              >
                ...
                <ListItemText
                  primary={`Clone ${this.props.scene.generatorWeights ? "Generator" : "Scene"}`}
                />
              </ListItem>
            </Tooltip>
            <Tooltip
              disableInteractive
              title={this.state.drawerOpen ? "" : "Scene Effects Import/Export"}
            >
              <ListItem
                button
                onClick={this.onOpenSceneEffectsMenu.bind(this)}
                className={clsx(
                  (this.props.tutorial == SDT.options1 ||
                    this.props.tutorial == SDT.effects1) &&
                    classes.disable,
            ...
            <Tooltip
              disableInteractive
              title={this.state.drawerOpen ? "" : "Export Scene"}
            >
              <ListItem
                button
            ...
            >
              <ListItem
                button
                onClick={this.props.onResetScene.bind(this, this.props.scene)}
                className={clsx(
                  (this.props.tutorial == SDT.options1 ||
                    this.props.tutorial == SDT.effects1) &&
                    classes.disable,
            ...
            <Tooltip
              disableInteractive
              title={this.state.drawerOpen ? "" : "Delete Scene"}
            >
              <ListItem
                button
                onClick={this.onDeleteScene.bind(this, this.props.scene)}
                className={clsx(
                  classes.deleteItem,
                  (this.props.tutorial == SDT.options1 ||
                    this.props.tutorial == SDT.effects1) &&
            ...
            >
              <DialogTitle id="Delete-title">
                Delete '{this.props.scene.name}'
              </DialogTitle>
              <DialogContent>
                <DialogContentText id="delete-description">
                  Are you sure you want to delete {this.props.scene.name}? It
                  will be automatically removed from all overlays/grids.
                </DialogContentText>
              </DialogContent>
              <DialogActions>
                <Button
                ...
                <Button
                  onClick={this.onFinishDeleteScene.bind(this)}
                  color="primary"
                >
                  OK
                </Button>
        ...
        <main className={classes.content}>
          ...
          <Container maxWidth={false} className={classes.container}>
            ...
            {this.props.scene.openTab === 3 && (
              <Typography
                className={clsx(
                  this.props.scene.openTab === 3 && classes.sourcesSection,
                )}
                component="div"
              >
                <div className={classes.tabPanel}>
                  ...
                  <Box className={classes.fill}>
                    <SourceList
                      ...
                      tutorial={
                        this.props.tutorial == SDGT.final
                          ? null
                          : this.props.tutorial
                      }
                      useWeights={
                        this.props.scene.weightFunction == WF.sources &&
                        this.props.scene.useWeights
                      }
        ...
        >
          ...
          <DialogActions>
            <Button
              onClick={this.onCopySceneEffects.bind(this)}
              color="secondary"
            >
              {this.state.confirmCopy && (
                <CheckCircleIcon className={classes.confirmCopy} />
              )}
              Copy to Clipboard
            </Button>
            <Button
              onClick={this.onApplySceneEffects.bind(this)}
              color="primary"
            >
              Apply
            </Button>
          ...
          <React.Fragment>
                ...
                <React.Fragment>
                  ...
                  <DialogContent>
                    <DialogContentText id="remove-all-description">
                      Are you sure you want to remove all sources from this
                      scene?
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
            ...
            <Tooltip disableInteractive title="URL" placement="left">
              <Fab
                className={clsx(
                  ...
                  this.state.openMenu == MO.new && classes.backdropTop,
                  this.state.openMenu != MO.new && classes.addButtonClose,
                  this.props.tutorial == SDT.add2 && classes.highlight,
                )}
            ...
            <Fab
              className={clsx(
                ...
                this.state.openMenu == MO.new && classes.backdropTop,
                (this.props.tutorial == SDT.add1 ||
                  this.props.tutorial == SDT.add2) &&
                  classes.backdropTop,
                this.props.tutorial == SDT.add1 && classes.highlight,
              )}
        ...
        {this.props.scene.openTab == 4 && (
          <React.Fragment>
              ...
              <React.Fragment>
                ...
                >
                  ...
                  <DialogActions>
                    ...
                    <Button
                      onClick={this.onFinishRemoveAllRules.bind(this)}
                      color="primary"
                    >
                      OK
                    </Button>
            ...
            <Tooltip
              disableInteractive
              title={
                this.props.scene.overrideIgnore
            ...
            >
              <Fab
                className={clsx(
                  ...
                  this.props.scene.overrideIgnore && classes.overrideOn,
                  !this.props.scene.overrideIgnore && classes.overrideOff,
                )}
            ...
            <Tooltip disableInteractive title="Max" placement="top">
              <Fab
                className={clsx(
                  ...
                  this.props.tutorial == SDGT.buttons &&
            ...
            >
              ...
              >
                <Fab
                  ...
                  className={clsx(
                    classes.addMenuButton,
                    this.props.tutorial == SDGT.generate && classes.highlight,
                  )}
            ...
            <Menu
              ...
              keepMounted
              className={clsx(
                this.props.tutorial == SDGT.buttons && classes.backdropTop,
              )}
              classes={{
                paper: clsx(
                  classes.tagMenu,
  ...
  componentDidUpdate(props: any, state: any) {
    if (
      ...
      props.scene.sources != this.props.scene.sources
    ) {
      this.setState({ displaySources: this.getDisplaySources() });
    }
  ...
  generateCallback() {
    if (this.props.scene.sources.length == 0) {
      this.setState({
        snackbarOpen: true,
        snackbar: "Sorry, no sources were found for these rules",
        snackbarSeverity: SS.warning,
      });
      ...
      this.setState({
        snackbarOpen: true,
        snackbar:
          "Generated scene with " +
          this.props.scene.sources.length +
          " sources",
  ...
  onOpenSceneEffectsMenu() {
    this.setState({
      openMenu: MO.effects,
      sceneEffects: getEffects(this.props.scene),
    });
  }
      ...
      for (let source of this.props.scene.sources) {
        ...
        for (let filter of this.state.filters) {
          if (filter == "<Offline>") {
            ...
            const countComplete =
              type == ST.video ? true : source.countComplete;
            switch (symbol) {
              case "=":
