...
class CaptionScriptor extends React.Component<CaptionScriptorProps> {
      ...
      <div className={classes.root}>
        ...
        >
          <Toolbar className={classes.headerBar}>
            ...
            <Tooltip
              disableInteractive
              title={this.state.fullscreen ? "Exit Fullscreen" : "Fullscreen"}
            >
              <span
                style={
                  this.state.scene == null ? { pointerEvents: "none" } : {}
                }
              >
                <IconButton
          ...
          <div className={clsx(classes.root, classes.fill)}>
            <Container maxWidth={false} className={classes.container}>
                  ...
                  <CardContent className={classes.menuCardContent}>
                    <Grid container spacing={2}>
                      ...
                      >
                        ...
                        >
                          <MenuItem onClick={this.onOpen.bind(this)}>
                            Open File
                          </MenuItem>
                          <MenuItem onClick={this.onOpenFromLibrary.bind(this)}>
                            Open From Library
                          </MenuItem>
                        </Menu>
                        <Tooltip disableInteractive title="Save">
                          <IconButton
                            onClick={this.onSaveMenu.bind(this)}
                            size="large"
                          >
                            <SaveIcon />
                          </IconButton>
                        ...
                        >
                          ...
                          <MenuItem
                            disabled={!this.state.captionScript.url}
                            onClick={this.onSaveToLibrary.bind(this)}
                          >
                            Save To Library
                          </MenuItem>
                        </Menu>
                        ...
                        <Tooltip disableInteractive title="Load From Scene">
                          <span
                            style={
                              this.state.sceneScripts == null ||
                              !this.state.sceneScripts.length
                                ? { pointerEvents: "none" }
                                : {}
                            }
                          >
                      ...
                      <Grid
                        ...
                        xs={12}
                        className={clsx(
                          this.props.tutorial == CST.actions &&
                            classes.backdropTopHighlight,
                        ...
                        <Grid container spacing={1}>
                          ...
                          <Grid item>
                            ...
                            >
                              <Button
                                ...
                                onClick={this.onAddBlink.bind(this)}
                                variant="outlined"
                              >
                                blink
                              </Button>
                          ...
                          <Grid item>
                            ...
                            >
                              <Button
                                className={classes.actionButton}
                                onClick={this.onAddCap.bind(this)}
                                variant="outlined"
                              >
                                cap
                              </Button>
                          ...
                          <Grid item>
                            ...
                            >
                              <Button
                                className={classes.actionButton}
                                onClick={this.onAddBigCap.bind(this)}
                                variant="outlined"
                              >
                                bigcap
                              </Button>
                          ...
                          <Grid item>
                            ...
                            >
                              <Button
                                className={classes.actionButton}
                                onClick={this.onAddCount.bind(this)}
                                variant="outlined"
                              >
                                count
                              </Button>
                          ...
                          <Grid item>
                            ...
                            >
                              <Button
                                className={classes.actionButton}
                                onClick={this.onAddWait.bind(this)}
                                variant="outlined"
                              >
                                wait
                              </Button>
                          ...
                          <Grid item>
                            ...
                            >
                              <Button
                                className={classes.actionButton}
                                onClick={this.onAddAdvance.bind(this)}
                                variant="outlined"
                              >
                                advance
                              </Button>
                          ...
                          <Grid item>
                            ...
                            >
                              <Button
                                className={classes.actionButton}
                                onClick={this.onAddPlayAudio.bind(this)}
                                variant="outlined"
                              >
                                playAudio
                              </Button>
                        ...
                        <Grid container spacing={1}>
                          ...
                          <Grid item>
                            ...
                            >
                              <Button
                                ...
                                onClick={this.onAddStoreAudio.bind(this)}
                                variant="outlined"
                              >
                                storeAudio
                              </Button>
                          ...
                          <Grid item>
                            ...
                            >
                              <Button
                                className={classes.storeButton}
                                onClick={this.onAddStorePhrase.bind(this)}
                                variant="outlined"
                              >
                                storePhrase
                              </Button>
              ...
              <div
                className={clsx(
                  classes.playerGrid,
                  this.props.tutorial == CST.player &&
                    classes.backdropTopHighlight,
                )}
              >
                {this.state.scene && (
                  <Player
                    ...
                    onUpdateScene={this.onUpdateScene.bind(this)}
                    captionProgramJumpToHack={
                      this.state.captionProgramJumpToHack
                    }
                    tutorial={null}
                    getCurrentTimestamp={
                      this.state.fullscreen ? undefined : getTimestamp
                    }
                    cache={() => {}}
                    setCount={() => {}}
                    systemMessage={() => {}}
                ...
                {!this.state.scene &&
                  ...
                  this.state.captionScript.script.length > 0 && (
                    <div
                      className={clsx(
                        !this.state.fullscreen && classes.relative,
                      )}
                    >
                      <CaptionProgram
        ...
        >
          ...
          <DialogContent>
            ...
            >
              {this.state.sceneScripts &&
                this.state.sceneScripts.map((s, i) => (
                  <MenuItem key={i} value={s.url}>
                    {s.url}
                  </MenuItem>
                ))}
            </Select>
          ...
          <DialogActions>
            ...
            <Button
              disabled={!this.state.selectScript.length}
              onClick={this.onConfirmLoadFromScene.bind(this)}
              color="primary"
            >
              Load Script
            </Button>
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              onClick={this.onSaveThen.bind(this, menuThen)}
              color="primary"
            >
              Save Changes
            </Button>
  ...
  onLoadFromScene() {
    if (!this.state.sceneScripts.length || this.state.loadFromSceneError)
      return;
    if (this.state.scriptChanged) {
  ...
  onOpenScriptSelect() {
    const defScript =
      this.state.sceneScripts != null && this.state.sceneScripts.length
        ? this.state.sceneScripts[0].url
        : "";
  ...
  onUpdateScript(script: string, changed = false) {
    ...
    if (this.state.scene) {
      ...
      newScene.scriptPlaylists = [
        { scripts: [newScript], shuffle: false, repeat: RP.one },
      ];
      this.setState({
        scene: newScene,
        captionScript: newScript,
        error: null,
        scriptChanged: changed ? true : this.state.scriptChanged,
      });
    } else {
      this.setState({
        captionScript: newScript,
  ...
  onChangeScene(sceneID: number) {
    ...
    const scene = JSON.parse(
      JSON.stringify(this.props.scenes.find((s) => s.id == sceneID)),
    );
    ...
    scene.scriptPlaylists = [
      { scripts: [this.state.captionScript], shuffle: false, repeat: RP.one },
    ];
  ...
  onUpdateOptions(property: string, fn: (options: FontSettingsI) => void) {
    ...
    if (this.state.scene) {
      const newScene = JSON.parse(JSON.stringify(this.state.scene));
      newScene.scriptPlaylists = [
        { scripts: [script], shuffle: false, repeat: RP.one },
      ];
      this.setState({
        scene: newScene,
