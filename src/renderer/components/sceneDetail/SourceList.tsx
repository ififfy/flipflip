          ...
          <Sortable
            ...
            {this.props.sources.map((source) =>
              <ListItem
                ...
                className={clsx(classes.source, this.props.newMenuOpen && classes.sourceMenuOpen)}>
                <ListItemAvatar>
                ...
                {this.state.isEditing != source.id && (
                  <ListItemSecondaryAction className={clsx(classes.source, this.props.newMenuOpen && classes.sourceMenuOpen)}>
                    {source.count > 0 && (
                      <Chip
